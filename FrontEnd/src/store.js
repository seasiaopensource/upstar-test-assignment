...
export default new Vuex.Store({
  ...
  getters: {
    ...
    getCurrentBoxPopupCart: state => state.currentBox,
    getBoxPopupCart: state => state.showBoxPopupCart,
    getCurrentProduct: state => state.currentProduct,
    getShowModal: state => state.showModal,
    getPopupCart: state => state.showPopupCart,
    getBoxPlan: state => state.boxplans,
  },
  mutations: {
    ...
    SHOW_BOX_POPUP_CART: (state) => {
      state.showBoxPopupCart = !state.showBoxPopupCart;
    },
  ...
  actions: {
    ...
    showOrHiddenBoxPopupCart: (context) => {
      context.commit('SHOW_BOX_POPUP_CART');
    },
    addBox: (context, box) => {
      context.commit('ADD_BOX', box);
    },
    currentBox: (context, box) => {
      context.commit('CURRENT_BOX', box);
    },
  },
});
